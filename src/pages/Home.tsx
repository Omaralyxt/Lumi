...
Vou continuar a implementação da página Home, completando a seção 4 e adicionando as seções restantes:

<dyad-write path="src/pages/Home.tsx" description="Página Home completa com todas as seções">
"use client";
